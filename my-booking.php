...
<title>Ets Nassirou Location De Voiture | Reservations </title>
<!--Bootstrap -->
...
<li>
                ...
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Confirmer</a>
                           <div class="clearfix"></div>
        </div>

              <?php } else if($result->Status==2) { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Annuler</a>
            <div class="clearfix"></div>
        </div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Pas Encore Confirmer</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
