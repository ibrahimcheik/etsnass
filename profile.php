...
<title>Ets Nassirou Location De Voiture | Profile</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Configuration Generale</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Numbero Telephone</label>
            ...
            <div class="form-group">
              <label class="control-label">Date De Naissance&nbsp;(jj/mm/aaaa)</label>
              <input class="form-control white_bg" value="<?php echo htmlentities($result->dob);?>" name="dob" placeholder="jj/mm/aaaa" id="birth-date" type="text" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Enregistrer Changement <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
