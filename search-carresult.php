...
<title>Ets Nassirou Location De Voiture | Liste Des Véhicules</title>
<!--Bootstrap -->
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?>Véhicule Lister</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">Voir Détail <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Trouve Votre Véhicule </h5>
          </div>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control">
                  <option>Sélectionner Type De Carburant</option>
...
<option value="GNC">GNC</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Chercher Un Véhicule</button>
              </div>
            </form>
          </div>
        </div>
