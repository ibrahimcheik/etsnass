...
})(window,document,'script','dataLayer','GTM-5P4QJJ4');</script>
<!-- End Google Tag Manager -->
    <!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-134629918-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-134629918-1');
</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5P4QJJ4"
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Trouver La Voiture De Votre Choix.</h1>
            <p>Nous Avons Plus De 100 Voiture A Votre Disposition. </p>
            <a href="page.php?type=aboutus" class="btn">Plus d'Information <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Capacite</li>
</ul>
</div>
...
<span class="price">FCFA<?php echo htmlentities($result->PricePerDay);?> /Jour</span> 
</div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Nos Clients <span>Deja Satisfait</span></h2>
    </div>
    <div class="row">
