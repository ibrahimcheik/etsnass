...
<title>Ets Nassirou Location De Voiture | Commentaires </title>
<!--Bootstrap -->
  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">Mes Commentaires </h5>
              ...
              <li>
                ...
                <div>
                 <p><?php echo htmlentities($result->Testimonial);?> </p>
                   <p><b>Date Poster:</b><?php echo htmlentities($result->PostingDate);?> </p>
                </div>
