...
<head>
	...
	<title>Portail Etsnass |Admin Gestion Des Témoignages   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gerer Témoignages</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Témoignages Des Utiisateurs</div>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous Vraiment Marque Comme actif ?')"> Inactif</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous Vraiment Marque Comme Inactif ?')"> Actif</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
