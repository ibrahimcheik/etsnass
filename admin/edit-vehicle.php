...
<head>
	...
	<title>Portail Etsnass | Admin Modifier Voiture</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Modifier Une Voiture</h2>
...
<label class="col-sm-2 control-label">Titre De La Voiture<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<div class="col-sm-12">
<h4><b>Les Image De La Voiture</b></h4>
</div>
</div>
...
{
echo htmlentities("Fichier Non Disponible");
} else {?>
...
<label for="inlineCheckbox2"> Serrures électriques </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Capteur de collision </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Sauvegarder les modifications</button>
												</div>
											</div>
