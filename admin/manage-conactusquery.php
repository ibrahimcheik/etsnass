...
<head>
	...
	<title>Portail Etsnass |Admin  Gérer les requêtes   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gérer Les Demandes De Contact</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Requêtes De L'utilisateur</div>
...
<td><a href="manage-conactusquery.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous Vraiment Marquer Comme Lu ?')" >En Attente</a>
</td>
<?php } ?>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
