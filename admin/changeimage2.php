...
<head>
	...
	<title>Portail Etsnass | Admin Mise A Jour Image 2</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Vehicule Image 2 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Vehicule Image 2 Detail</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image2 Actuel</label>
<?php 
$id=intval($_GET['imgid']);
