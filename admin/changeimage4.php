...
<head>
	...
	<title>Portail Etsnass | Admin Mise A Jour Image 4</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Vehicule Image 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Vehicule Image 4 Details</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image4 Actuel</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Telecharger Nouveau Image 4<span style="color:red">*</span></label>
												<div class="col-sm-8">
