...
<head>
	...
	<title>Portail Etsnass |Admin Gérer Les Reservations   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gérer Les Réservations</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Informations Sur Les Réservations</div>
...
if($result->Status==0)
{
echo htmlentities('Pas Encore Confirmer');
...
echo htmlentities('Confirmer');
 	...
 	echo htmlentities('Annulé');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous Vraiment Confirmer Cette Réservation')"> Confirmer</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous Vraiment Annuler Cette Réservation?')"> Annulé </a>
</td>
