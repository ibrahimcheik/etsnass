...
<head>
	...
	<title>Portail Etsnass | Admin Mise A Jour Contact De la Societe</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Mise A Jour Contact De La Societe</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Champ Du Formulaire Contact</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label"> Numero de Tel </label>
												<div class="col-sm-8">
