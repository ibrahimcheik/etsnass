...
<head>
	...
	<title>Portail Etsnass | Admin Gerer Les Pages</title>
...
<body>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gerer Pages </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Champ Formulaire Page</div>
                  ...
                  <option value="manage-pages.php?type=aboutus">A Propos De Nous</option> 
                  <option value="manage-pages.php?type=faqs">FAQ</option>
                </select>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Page Sélectionnée</label>
												<div class="col-sm-8">
						<?php
			...
			{
				case "terms" :
									echo "Conditions Et Termes";
									break;
				
				case "privacy" :
									echo "Confidentialité Et Politique";
									break;
