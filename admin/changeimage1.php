...
<head>
	...
	<title>Portail Etsnass | Admin Mise A Jour Image 1</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Véhicule Image 1 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Véhicule Image 1 Détail</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image1 Actuel</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Telecharger Nouveau Image 1<span style="color:red">*</span></label>
												<div class="col-sm-8">
