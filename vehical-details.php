...
<title>Portail etsnass | Detail Voiture </title>
<!--Bootstrap -->
...
<link rel="stylesheet" href="assets/css/jquery-ui-1.10.1.custom.min.css" />
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>FCFA<?php echo htmlentities($result->PricePerDay);?> </p>/Jour
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <input  id="date" class="form-control" name="fromdate" placeholder="Date Depart(jj/mm/aaaa)" required>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="todate" placeholder="Date Retour(jj/mm/aaaa)" required>
            </div>
            <div class="form-group">
...
<script src="assets/js/jquery.ui.datepicker-zh-CN.js"></script>
