...
echo "<script type='text/javascript'> document.location = '$currentpage'; </script>";
  ...
  echo "<script>alert('Detail Invalide');</script>";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer text-center">
        <p>Pas De Compte? <a href="#signupform" data-toggle="modal" data-dismiss="modal">S'enregistrer</a></p>
        <p><a href="#forgotpassword" data-toggle="modal" data-dismiss="modal">Mot De Passe Oublie?</a></p>
